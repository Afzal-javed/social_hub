    ...
    return (
        <section className="w-full">
            <div className="w-[90%] md:w-[80%] lg:w-[70%] xl:w-[60%] m-auto my-5 p-5 flex flex-col items-center justify-center shadow-lg">
                ...
                <p className="w-full text-center text-slate-500 text-lg my-2">
                    <Link className="cursor-pointer text-black" href="/resetPassword">
                        Forget Password
                    </Link>
                </p>
                <p className="w-full text-center text-slate-500 text-lg my-2">
                    Don't have an account?{' '}
                    <Link className="cursor-pointer text-black" href="/register">
                        Register
                    </Link>
                </p>
            </div>
